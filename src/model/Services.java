...
///////////////////////////////////////////////////////////////////////////////////////////	
	 ...
	 * @throws IOException
	 */
	public ArrayList<Movie> getMovies(Connection mysqlConnect) throws IOException {
		
		/** Create ArrayList for movies */
		ArrayList<Movie> moviesList = new ArrayList<>();
		
		/** Declare String with sql syntax */
		...
		try(PreparedStatement prepStatement = mysqlConnect.prepareStatement(sqlQuery)) {
			...
			while(rs.next()) { // while result set contains data
				...
				Movie movie = new Movie(id, movieTitle, year, genre, rating, votes, cast, director, description);
		...
		try(PreparedStatement statementSelect = mysqlConnect.prepareStatement(sqlSelect)) {
			...
			while(rs.next()) {
				...
				if((idUser == userId) && (idMovie == movieId)) {
					System.out.println("You already submitted vote for this movie!!!");
					return true;
				} 
			}
		} catch (SQLException e) {
...
///////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * @param mysqlConnect
	 */
	public void vote(int userId, int movieId, Connection mysqlConnect) {
		
		String sqlInsert = " INSERT INTO `user_votes`(`userID`, `movieID`) VALUES(?, ?) ";
